...
export default function Cards() {
  ...
  return (
    ...
    <Card icon={<Wallet size={30} />} iconbg={' bg-yellow-500'} title={'Chrono Package'} amount={`${total?.totalrequestminecoin.toLocaleString()}`} subtitle={'User Total Miner Request'} text={''} loading={loading}/>
