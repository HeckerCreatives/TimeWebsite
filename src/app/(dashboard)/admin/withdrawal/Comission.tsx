...
export default function Comissionlist() {
  ...
  return (
    <div className=' relative w-full flex flex-col items-center gap-8 max-w-[1440px] min-h-[500px] h-auto mt-12 bg-zinc-800 p-6'>
        <div className=' flex md:flex-row flex-col items-center justify-between absolute top-0 w-[98%] z-30 gap-2 h-auto md:h-[55px] bg-yellow-500 p-2 rounded-sm -translate-y-4'>
